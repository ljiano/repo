...
<%@ taglib prefix="um" uri="/um/tag" %>
<%@ taglib prefix="umfn" uri="/um/umfn" %>
<%
    request.setAttribute("contextPath", request.getContextPath());
    request.setAttribute("path", request.getContextPath());
%>
<!-- 新 Bootstrap 核心 CSS 文件 -->
<link href="${contextPath}/script/bootstrap/3.3.7/css/bootstrap.css" rel="stylesheet"/>
<link href="${contextPath}/script/bootstrap/css/datepicker.css" rel="stylesheet"/>
<%--<link href="${contextPath}/script/bootstrap/css/bootstrap.css" rel="stylesheet"/>--%>
<%--<link href="${contextPath}/script/bootstrap/less/datepicker.less" rel="stylesheet"/>--%>
...
<script type="text/javascript" src="${contextPath}/script/js/um.js"></script>
...
<script type="text/javascript" src="${contextPath}/script/bootstrap/3.3.7/js/bootstrap.js"></script>
